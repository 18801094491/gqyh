...
<template>
  <div class="">
    <div class="table-page-search-wrapper">
      <!-- 搜索区域 -->
      <a-form layout="inline" style="margin: 10px 0px -40px 0px">
        <a-row :gutter="10">
          <a-col :md="10" :sm="12">
    ...
    <a-card :bordered="false">
      <!-- 操作按钮区域 -->
      <div class="table-operator" :md="12" :sm="24" style="margin-left: 8px">
        <a-button
          @click="handleAdd"
          type="primary"
          icon="plus"
        ...
        <a-button @click="handleAddUserDepart" type="primary" icon="plus"
          >添加已有用户</a-button
        >
      ...
      <!-- table区域-begin -->
      <div>
        <div class="ant-alert ant-alert-info" style="margin: 0 10px 16px 10px">
  ...
  methods: {
    ...
    handleAdd: function () {
      if (this.currentDeptId == "") {
        ...
        this.$refs.modalForm.departDisabled = true;
        this.$refs.modalForm.userDepartModel.departIdList = [
          this.currentDeptId,
        ]; //传入一个部门id
