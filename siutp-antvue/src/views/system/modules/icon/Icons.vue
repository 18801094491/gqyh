    ...
    <a-tabs>
      ...
      <a-tab-pane tab="品牌和标识" key="6">
        <ul>
          ...
          <!-- <li class="icons-list" v-for="icon in icons.zdyIcons" :key="icon">
            <icon-font :type="icon" :title="icon" @click="chooseIcon(icon)" :class="{'active':activeIndex === icon}"/>
...
const zdyIcons = ['icon-tuichu', 'icon-facebook', 'icon-twitter']
