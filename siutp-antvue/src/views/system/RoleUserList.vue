...
<template>
  <div class="margin12">
    <!-- 第一块 -->
    <a-row :gutter="10" sytle="margin: 0">
      <a-col :span="currentRoleId ? 12 : 24">
        ...
        <a-card :bordered="false" style="max-height: 700px; min-height: 500px">
          <!-- 操作按钮区域 -->
      ...
      <a-col :span="12" v-if="currentRoleId">
        <div class="screenCommonBox">
          <!-- 查询区域 -->
          <div class="table-page-search-wrapper">
            <a-form layout="inline" @keyup.enter.native="searchQuery">
        ...
        <a-card :bordered="false" style="max-height: 700px; min-height: 500px">
          <!-- 操作按钮区域 -->
          <div class="table-operator">
            <a-button @click="handleAdd2" type="primary" icon="plus"
              >用户录入</a-button
            >
            <!--<a-button @click="handleEdit2" type="primary" icon="edit">用户编辑</a-button>-->
