  ...
  <div class="margin12">
    <div class="screenCommonBox">
      ...
      <a-row style="margin-left: 14px">
        <a-button @click="handleAdd(2)" class="ant-btn-mg" type="primary"
          >添加子部门</a-button
        >
        <a-button @click="handleAdd(1)" class="ant-btn-mg" type="primary"
          >添加一级部门</a-button
        >
        <a-button
          type="primary"
        ...
        <!-- <a-button title="删除多条数据" @click="batchDel" class="ant-btn-mg" type="default">批量删除</a-button> -->
