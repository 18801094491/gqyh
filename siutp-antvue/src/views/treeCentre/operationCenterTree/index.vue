<template>
    <div class="margin12">
        <a-card :bordered="false">
            ...
            <add-model ref="modalForm" @ok="modalFormOk" modelType='ope'></add-model>
...
export default {
    ...
    data () {
        return {
            ...
            url: {
                list: "/centre/opt/equ/list/", // 根节点(已改)
                childList: "/centre/opt/equ/list/", // 点击加号获取子节点
                delete: "/centre/opt/equ/delete", // 删除节点
