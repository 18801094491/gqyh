...
<template>
    <div class="table-page-search-wrapper">
	    ...
	    <a-drawer :title="detailsTitle+'详情'" :width="800" @close="detailsClose" :visible="detailsvisible">   
...
<script>
import equiqKnowledge from '@/assets/js/treeCentre/modules/modules/equiqKnowledge.js';
export default{
	...equiqKnowledge
}
</script>
