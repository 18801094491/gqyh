<template>
    <div class="margin12">
        <a-card :bordered="false">
            ...
            <add-model ref="modalForm" @ok="modalFormOk" :modelType="'inf'"></add-model>
...
export default {
    ...
    data () {
        return {
            ...
            url: {
                list: "/centre/inf/equ/list/", // 根节点
                childList: "/centre/inf/equ/list/", // 点击加号获取子节点
                delete: "/centre/inf/equ/delete", // 删除节点
