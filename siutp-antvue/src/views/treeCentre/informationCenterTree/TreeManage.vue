                        ...
                        <a-col :md="6" :sm="12">
                            <a-form-item label="设备类型">
                                <a-select v-model="queryParam.equipmentType" placeholder="请选择设备类型">
                                    <a-select-option :value="item.code" v-for="(item,index) in modelTypeList2" :key="index">
                                        {{item.title}}
                                    </a-select-option>
                                </a-select>
                            </a-form-item>
                        ...
                        <a-col :md="6" :sm="12">
                            <a-form-item label="供应商">
                                <a-select v-model="queryParam.equipmentSupplier" placeholder="请选择供应商">
                                    <a-select-option value="">全部</a-select-option>
                                    <a-select-option v-for="(item,index) in supplierClassificationList2" :value="item.id" :key="index">
                                        {{item.supplierName}}
                                    </a-select-option>
                                </a-select>
                            </a-form-item>
                        </a-col>
                        <a-col :md="5" :sm="12" :offset="7">
...
<script>
    import index from '@/assets/js/treeCentre/informationCenterTree/treeManage.js'
