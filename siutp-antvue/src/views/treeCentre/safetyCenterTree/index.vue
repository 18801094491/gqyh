<template>
    <div class="margin12">
        <a-card :bordered="false">
            ...
            <add-model ref="modalForm" @ok="modalFormOk" modelType='saf'></add-model>
...
export default {
    ...
    data () {
        return {
            ...
            url: {
                list: "/centre/sec/equ/list/", // 根节点(已改)
                childList: "/centre/sec/equ/list/", // 点击加号获取子节点
                delete: "/centre/sec/equ/delete", // 删除节点
                deleteBatch: "/equipment/secLabel/deleteBatch", //批量删除操作
    ...
    methods: {
        ...
        handleDeletes (treeId) {
            let _this = this;
            let data = {id: treeId};
            axios.delete('/centre/universal/bind/delete',{
                params: data
            }).then(res => {
                let result = res.data;
                if (res.code * 1 == 200) {
