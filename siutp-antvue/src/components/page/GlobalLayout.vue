  ...
  <a-layout class="layout" :class="[device]">
    ...
    <a-layout
      ...
      <global-header
        ...
        :device="device"
        @toggle="toggle"
        :style="{position: 'fixed', right: 0, width: 'calc(100% - 170px)', zIndex: 3}"
      />

      <!-- layout content -->
      <a-layout-content :style="{ zIndex: 1,marginTop: '50px', height: '100%', paddingTop: fixedHeader ? '59px' : '0' }">
        <slot></slot>
      </a-layout-content>
...
<script>
//根据ant官网a-layout系列布局组件，进行二次封装的组件
