        ...
        <div v-if="actionButton" class="action-button">
          ...
          <template v-if="selectedRowIds.length > 0">
            ...
            <template v-if="showClearSelectButton">
              <a-button icon="delete" @click="handleClickClearSelection"
                >清空选择</a-button
              >
              <span class="gap"></span>
            </template>
    ...
    <div :id="`${caseId}inputTable`" class="input-table">
      ...
      >
        ...
        <div :id="`${caseId}tbody`" class="tbody" :style="tbodyStyle">
          ...
          <div
            class="tr-expand"
            :style="`height:${getExpandHeight}px; z-index:${
              loading ? '11' : '9'
            };`"
          ></div>
          <!-- 无数据时显示 -->
          ...
          >
            ...
            <template v-for="(row, rowIndex) in rows">
              ...
              <div
                v-if="
                  rowIndex >=
                    parseInt(`${(scrollTop - rowHeight) / rowHeight}`) &&
                ...
                class="tr"
                :class="
                  selectedRowIds.indexOf(row.id) !== -1 ? 'tr-checked' : ''
                "
              ...
              >
                ...
                >
                  ...
                  <template v-for="(id, i) in [`${col.key}${row.id}`]">
                      ...
                      >
                        ...
                        >
                          <a-select
                            ...
                            :placeholder="replaceProps(col, col.placeholder)"
                            @change="
                              (v) => handleChangeSelectCommon(v, id, row, col)
                            "
                    ...
                    <template
                      v-else-if="
                        col.type === formTypes.date ||
                        col.type === formTypes.datetime
                      "
                    >
                      <a-tooltip
                        :key="i"
                      ...
                      >
                        ...
                        >
                          <a-radio-group
                            ...
                            @change="
                              (e) =>
                                handleRadioChange(e.target.value, id, row, col)
                            "
                          >
                            <a-radio
                      ...
                      >
                        ...
                        >
                          <a-select
                            ...
                            :placeholder="replaceProps(col, col.placeholder)"
                            @change="
                              (v) => handleMultiSelectChange(v, id, row, col)
                            "
                            allowClear
                          >
                          </a-select>
                      ...
                      >
                        ...
                        >
                          <a-select
                            ...
                            :placeholder="replaceProps(col, col.placeholder)"
                            @change="
                              (v) => handleSearchSelectChange(v, id, row, col)
                            "
                            allowClear
                          >
                          </a-select>
    ...
    getValuesSync(options = {}) {
      ...
      for (let value of inputValues) {
        ...
        this.columns.forEach((column) => {
          ...
          // 检查表单验证
          if (validate === true) {
            let results = this.validateOneInput(
              value[column.key],
              value,
              column,
              notPassedIds,
