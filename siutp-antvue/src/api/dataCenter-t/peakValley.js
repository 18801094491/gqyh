...
export default {
    ...
    mounted() {
        ...
        //平均值分析-统计项目下拉值获取
        (function (_this) {
            axios.get('/iot/vardata/analysis/v1/item/ce3992ca69c911ea9fded05099cd3eff')
                .then(res => {
                    if (res.code * 1 == 200) {
    ...
    methods: {
        ...
        updata() {
            ...
            let data = {
                ...
                startTime: this.queryParam.startTime ? new Date(this.moment(this.queryParam.startTime).format('YYYY-MM-DD HH:mm:ss')).getTime() : '',
                endTime: this.queryParam.endTime ? new Date(this.moment(this.queryParam.endTime).format('YYYY-MM-DD HH:mm:ss')).getTime() : ''
            };
            (function (data, _this) {
                axios.get('/iot/vardata/analysis/v1/ce3992ca69c911ea9fded05099cd3eff', {
                    params: data
                }).then(res => {
                    _this.loading = false;
                    _this.dataSource = [];
        ...
        handleExportXls(fileName) {
            ...
            downFile('/iot/vardata/analysis/v1/exprot/ce3992ca69c911ea9fded05099cd3eff', param).then((data) => {
                if (!data) {
