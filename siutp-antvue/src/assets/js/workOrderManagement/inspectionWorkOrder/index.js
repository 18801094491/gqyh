...
} from '@/api/workOrderManagement/inspectionWorkOrder/index.js'
...
export default {
    ...
    data() {
        return {
            ...
            url: {
                list: "/worklist/workList/list/insp",
            },
            dataSource: [],
            loading: false,
            visible: false,
    ...
    methods: {
        ...
        addSubmit() {
            ...
            this.matterListDataSource.forEach((item) => {
                if(item.type != 3) {
                    ...
                    this.matterList.push(matterList);
                }else {
                    questionObject = {
                        id: item.id,
                        seq: item.seq,
        ...
        onShowMonitorModal(id) { //显示工单监控弹层
            onWorkListQueryChange(id, this, data => {
                ...
                this.$refs.modalMonitor.showModal(id, 'inspection');
