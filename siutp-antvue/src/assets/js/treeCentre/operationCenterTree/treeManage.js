import { 
    ...
    getQueryNameList2,
} from '@/api/treeCentre/operationCenterTree/treeManage.js'
...
export default {
    ...
    data() {
        return {
            ...
            url: {
                list: "/centre/opt/equ/equlist",
                add: "/centre/opt/equ/add", // 新增节点
                edit: "/centre/opt/equ/edit",  // 编辑节点
                checkCode:"/sys/category/checkCode",
                infoUrl: '/centre/opt/equ/query', //通过id查询
            },
            parentUrl: '/centre/opt/equ/getAll/',
            expandedRowKeys: [],
    ...
    methods: {
        ...
        handleOk() {
            ...
            this.$nextTick(() => {
                ...
                httpAction('/centre/opt/equ/treeobj/bind/', data, 'post')
                    .then(res => {
                        let result = res.data;
                        if (res.code * 1 == 200) {
        ...
        handleDeletes (id) {
            ...
            let parentId = '';
            let data = {dataId: id};
            httpAction('/centre/opt/equ/treeobj/unbind/', data, 'post')
                .then(res => {
                    let result = res.data;
                    if (res.code * 1 == 200) {
                        _this.$message.success(res.message);
