    ...
    export default {
        ...
        methods: {
            ...
            edit(record) {
                ...
                this.visible = true;
                this.$nextTick(() => {
                    this.form.setFieldsValue(pick(this.model, 'parentId', 'labelName'))
...
//          console.log("表单提交数据",formData)
    ...
    //operationCenter/labelmanagement/addmodel.vue 页面组件混入了operationCenter/labelmanagement/addmodel.js