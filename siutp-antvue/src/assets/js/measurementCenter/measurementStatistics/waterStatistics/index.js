...
//用水量统计-每日累计用水量查询
const getmeterFlowQueryNetFlowDay = (data, _this) => {
...
//用水量统计-客户用水累计统计
const getmeterFlowQueryAllNetFlowDay = (_this) => {
...
export default {
  ...
  methods:{
    ...
    updata(){
      ...
      getmeterFlowQueryNetFlowDay(data,this);
    ...
    //客户用水累计统计
    updata2(){
      getmeterFlowQueryAllNetFlowDay(this);
    },
    //每日累计用水量分析天数改变数据刷新
    statisticst(e){
