...
import com.zcdy.dsc.common.constant.CommonSendStatus;
...
import com.zcdy.dsc.modules.system.service.ISysAnnouncementService;
...
public class SysAnnouncementController {
	...
	public Result<Map<String,Object>> listByUser() {
		...
		Map<String,Object> sysMsgMap = new HashMap<String, Object>(4);
    ...
    public ModelAndView exportXls(SysAnnouncement sysAnnouncement,HttpServletRequest request) {
        ...
        mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("系统通告列表数据", secondTitle, "导出信息"));
