...
import com.zcdy.dsc.modules.system.entity.SysUserAgent;
import com.zcdy.dsc.modules.system.service.ISysUserAgentService;
...
public class SysUserAgentController {
  ...
  public ModelAndView exportXls(SysUserAgent sysUserAgent,HttpServletRequest request) {
      ...
      mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("用户代理人设置列表数据", secondTitle, "导出信息"));
