 ...
 *
 * @author: songguang.jiao 创建时间: 2020年6月22日 上午11:16:32
 */
public class SendWorkingDataSmsJobV2 implements Job {
    ...
    public void execute(JobExecutionContext context) throws JobExecutionException {
        ...
        sendSmsUtil.sendSms(EventConstant.AUTO_RUNNING_IOT_DATA, workDataJson);
    }
        ...
        for (PointData data : datas) {
            ...
            if ("min".equals(minOrMax)) {
                ...
                if (data.getVarName().equals(VariNameConstant.HDSC)) {
                    ...
                    workDataJson.put("minVHDL", occurValue);
                }
            } else {
                if (data.getVarName().equals(VariNameConstant.YL_7_01)) {
                ...
                if (data.getVarName().equals(VariNameConstant.HDSC)) {
                    ...
                    this.queryReferenceDataHd(startTime, occurTimeLong, workDataJson, equipMap, minOrMax);
                    workDataJson.put("maxVHDL", occurValue);
                }
            }
        }
