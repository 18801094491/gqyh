...
public class DictAspect {
    ...
    // 定义切点Pointcut
    @Pointcut("execution(public * com.zcdy.dsc.modules.message.controller.*Controller.queryPageList(..))"
            + "||execution(public * com.zcdy.dsc.modules.system.controller.*Controller.queryPageList(..))"
            + "||execution(public * com.zcdy.dsc.modules.personal.controller.*Controller.*(..))")
