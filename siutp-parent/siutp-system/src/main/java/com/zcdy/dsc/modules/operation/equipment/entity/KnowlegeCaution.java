 ...
 */
@Data
@TableName("opt_knowlege_caution")
@EqualsAndHashCode(callSuper = false)
@Accessors(chain = true)
@ApiModel(value = "opt_knowlege_caution对象", description = "知识库条目操作注意事项")
public class KnowlegeCaution {
    ...
    private java.lang.String cautionItem;
    /**
     * 展示顺序，升序
     */
