...
import java.util.List;
 ...
 /**
 * @Description: 信息中心-设备树形结构
 * @Author: 在信汇通
 * @Date:   2021-02-20 11:33:45
 * @Version: V1.0
 */
@Slf4j
@Api(tags="信息中心-设备树形结构")
@RestController
@RequestMapping("/centre/inf/equ/")
public class CentreTreeInfEquController extends CentreTreeBaseController {
     ...
     * 数据类型
     */
    private final static String treeCentreType = CentreTypeEnum.INF.getValue();
	/**
	 * 对象类型
	 */
	 ...
	 * @return
	 */
	@AutoLog(value = "信息中心-设备树形结构-子节点及绑定属性查询")
	@ApiOperation(value="信息中心-设备树形结构-子节点及绑定属性查询", notes="信息中心-设备树形结构-子节点及绑定属性查询")
	 ...
	 * @return
	 */
	@AutoLog(value = "信息中心-设备树形结构-获取全部树及节点-用于选择父节点")
	@ApiOperation(value="信息中心-设备树形结构-获取全部树及节点-用于选择父节点", notes="信息中心-设备树形结构-获取全部树及节点-用于选择父节点")
	 ...
	 * @return
	 */
	@AutoLog(value = "信息中心-设备树形结构-添加")
	@ApiOperation(value="信息中心-设备树形结构-添加", notes="信息中心-设备树形结构-添加")
	 ...
	 * @return
	 */
	@AutoLog(value = "信息中心-设备树形结构-编辑")
	@ApiOperation(value="信息中心-设备树形结构-编辑", notes="信息中心-设备树形结构-编辑")
	 ...
	 * @return
	 */
	@AutoLog(value = "信息中心-设备树形结构-通过id删除")
	@ApiOperation(value="信息中心-设备树形结构-通过id删除", notes="信息中心-设备树形结构-通过id删除")
	 ...
	 * @return
	 */
	@AutoLog(value = "信息中心-设备树形结构-通过id查询")
	@ApiOperation(value="信息中心-设备树形结构-通过id查询", notes="信息中心-设备树形结构-通过id查询")
