...
import com.zcdy.dsc.common.constant.DataBaseConstant;
...
import com.zcdy.dsc.common.system.vo.ComboModel;
...
public class SysBaseApiImpl implements ISysBaseApi {
	...
	public void sendSysAnnouncement(String fromUser, String toUser, String title, String msgContent) {
		...
		for(int i=0;i<userNames.length;i++) {
			if(ConvertUtils.isNotEmpty(userNames[i])) {
				SysUser sysUser = userMapper.getUserByName(userNames[i]);
				if(sysUser==null) {
					continue;
				}
