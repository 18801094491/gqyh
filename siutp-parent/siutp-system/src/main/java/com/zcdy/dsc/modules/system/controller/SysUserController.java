...
public class SysUserController {
    ...
    public ModelAndView exportXls(SysUser sysUser, HttpServletRequest request) {
        ...
        mv.addObject(NormalExcelConstants.PARAMS, new ExportParams("用户信息", secondTitle, "用户信息"));
    ...
    /**
     * 描述: 用户下拉列表-(id-value) @author： songguang.jiao 创建时间： 2020年1月19日 下午4:07:31 版本号:
     * V1.0
     */
    @ApiImplicitParams({@ApiImplicitParam(name = "name", value = "用户名称", paramType = "query")})
