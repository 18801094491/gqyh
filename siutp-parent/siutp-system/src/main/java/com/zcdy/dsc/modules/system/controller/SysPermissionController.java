...
import com.zcdy.dsc.modules.system.entity.SysRolePermission;
import com.zcdy.dsc.modules.system.model.SysPermissionTree;
...
import com.zcdy.dsc.modules.system.service.ISysRolePermissionService;
import com.zcdy.dsc.modules.system.service.ISysUserService;
import com.zcdy.dsc.modules.system.util.PermissionDataUtil;
...
//	}
	...
	public Result<String> saveRolePermission(@RequestBody JSONObject json) {
		...
		try {
			...
			this.shiroRealm.clearCache(principals);
			if(log.isInfoEnabled()){
	...
	private JSONObject getPermissionJsonObject(SysPermission permission) {
		...
		if (permission.getMenuType().equals(CommonConstant.MENU_TYPE_2)) {
			...
			if (isHttpUrl(permission.getUrl())) {
	 ...
	 * @return
	 */
	@GetMapping("/getRootPermission")
	public Result<List<SysPermission>> getRootPermission(HttpServletRequest req)
	{
		String username = JwtUtil.getUserNameByToken(req);
		List<SysPermission> permissionList = sysPermissionService.getRootPermissionByUser(username);
