...
/**
* @Description: 安全中心-设备树形结构
* @Author: 在信汇通
* @Date:   2021-02-20 11:33:45
* @Version: V1.0
*/
@Slf4j
@Api(tags="安全中心-设备树形结构")
@RestController
@RequestMapping("/centre/sec/equ/")
public class CentreTreeSecEquController extends CentreTreeBaseController {
    ...
    * 数据类型
    */
   private final static String treeCentreType = CentreTypeEnum.SEC.getValue();
   /**
    * 对象类型
    */
   private final static String treeObjectType = CentreTreeConstant.OBJ_TYPE_EQU;

    /**
     * 设备类型：视频监控
     * 安全中心设备列表只显示监控设
     */
   private final static String equType = TableConstant.VIDEO_SURVEILLANCE_TYPE;
    ...
    * @return
    */
   @AutoLog(value = "安全中心-设备树形结构-子节点及绑定属性查询")
   @ApiOperation(value="安全中心-设备树形结构-子节点及绑定属性查询", notes="安全中心-设备树形结构-子节点及绑定属性查询")
    ...
    * @return
    */
   @AutoLog(value = "安全中心-设备树形结构-获取全部树及节点-用于选择父节点")
   @ApiOperation(value="安全中心-设备树形结构-获取全部树及节点-用于选择父节点", notes="安全中心-设备树形结构-获取全部树及节点-用于选择父节点")
    ...
    * @return
    */
   @AutoLog(value = "安全中心-设备树形结构-添加")
   @ApiOperation(value="安全中心-设备树形结构-添加", notes="安全中心-设备树形结构-添加")
    ...
    * @return
    */
   @AutoLog(value = "安全中心-设备树形结构-编辑")
   @ApiOperation(value="安全中心-设备树形结构-编辑", notes="安全中心-设备树形结构-编辑")
    ...
    * @return
    */
   @AutoLog(value = "安全中心-设备树形结构-通过id删除")
   @ApiOperation(value="安全中心-设备树形结构-通过id删除", notes="安全中心-设备树形结构-通过id删除")
    ...
    * @return
    */
   @AutoLog(value = "安全中心-设备树形结构-通过id查询")
   @ApiOperation(value="安全中心-设备树形结构-通过id查询", notes="安全中心-设备树形结构-通过id查询")
   ...
   @AutoLog(value="树与设备-绑定")
   @ApiOperation(value="树与设备-绑定",notes="树与设备-绑定")
   ...
   @AutoLog(value="树与设备-解除绑定")
   @ApiOperation(value="树与设备-解除绑定",notes="树与设备-解除绑定")
   ...
   public ResultData<IPage<OptEquipmentModel>> queryEquPageList(EquipmentQueryParam param) {
       ...
       param.setEquipmentType(equType);//设备类型：视频监控
       return super.queryEquPageList(param);
   }

   @AutoLog(value = "信息设备-根据parentid查询节点和属性")
   @ApiOperation(value = "信息设备-根据parentid查询节点和属性", notes = "信息设备-根据parentid查询节点和属性")
   @GetMapping(value = "/getTreeEquAttrList")
   public ResultData<TreeListVo> getTreeEquAttrList(EquipmentQueryParam param) {
       param.setCentre(treeCentreType);
       param.setObjType(treeObjectType);
       return super.getTreeEquAttrList(param);
   }

   @AutoLog(value = "信息设备-根据页面节点、条件、属性查询设备列表")
   @ApiOperation(value = "信息设备-根据页面节点、条件、属性查询设备列表", notes = "信息设备-根据页面节点、条件、属性查询设备列表")
   @GetMapping(value = "/getEquListByAllSearch")
   public ResultData<?> getEquListByAllSearch(EquipmentQueryParam param) {
       param.setCentre(treeCentreType);
       param.setObjType(treeObjectType);
       param.setEquipmentType(equType);//设备类型：视频监控
       return super.getEquListByAllSearch(param);
   }
}