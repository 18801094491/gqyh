...
//	private String fileUploadPath;
	...
	public void addResourceHandlers(ResourceHandlerRegistry registry) {
		...
		registry.addResourceHandler("/public/**").addResourceLocations("classpath:/publics/");
//		registry.addResourceHandler("/res/file/**").addResourceLocations("file:" + fileUploadPath + "//");
	}
